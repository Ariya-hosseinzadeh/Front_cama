...
const DetialeProposalRecieve=(props)=>{
            ...
            const ReciveInvite=async ()=>{
                try{
                    let response=await fetchWithAuth(
                        `https://127.0.0.1:8000/classroom/proposal-recieve/${id}`
                        ,{
                            method:'GET',
    ...
    const handleSubmit=(e)=>{
        e.preventDefault()
        let data={...dataSend}
        fetchWithAuth(`https://127.0.0.1:8000/classroom/proposal-recieve/${id}`,{
            method:'PUT',
...
export default DetialeProposalRecieve